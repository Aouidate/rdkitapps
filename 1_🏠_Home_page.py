...
st.markdown("<h2 style='text-align: center; color: grey;'>Exploring Various Chemoinformatic Applications and Codes for Drug Discovery- A Compact Blog</h2>", unsafe_allow_html=True)
